...
class CustomUserCreationForm(UserCreationForm):
    ...
    class Meta:
        ...
        labels = {"username": "Username", "email": "Email Address", "role": "User Role"}
        help_texts = {
...
class ArticleForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if not self.fields["publisher"].queryset.exists():
            self.fields["publisher"].help_text = (
                "⚠ No publishers available. Please register one first."
            )
        for field in self.fields.values():
            field.widget.attrs.update({"class": "form-control"})
...
class PublisherForm(forms.ModelForm):
    ...
    class Meta:
        ...
        labels = {"name": "Publisher Name", "description": "Description"}
        help_texts = {
    ...
    def __init__(self, *args, **kwargs):
        ...
        for field in self.fields.values():
            field.widget.attrs.update({"class": "form-control"})
        self.fields["name"].widget.attrs.update({"placeholder": "Enter publisher name"})
